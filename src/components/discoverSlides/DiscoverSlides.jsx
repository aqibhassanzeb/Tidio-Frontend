                        ...
                        <div className='carouselBackgroundcolor'>
                            ...
                            <Carousel >
                                ...
                                <div className=' textcaroli d-flex'>
                                    <div className='textcarolinfo'>
                                        <h1 className='text-white'>2. Welcome message + discount</h1>
                                ...
                                <div className=' textcaroli d-flex'>
                                    <div className='textcarolinfo'>
                                        <h1 className='text-white'>8. Sales monitoring dashboard</h1>
                                        <p className='text-white '>
                                ...
                                <div className=' textcaroli d-flex'>
                                    <div className='textcarolinfo'>
                                        ...
                                        View your customers’ carts<br/>
                                        Track what they are browsing on your website<br/>
                                        Send them offers and links to products based on their website behavior<br/>
                                ...
                                <div className=' textcaroli d-flex'>
                                    <div className='textcarolinfo'>
                                        <h1 className='text-white'>10. Export visitors’ data</h1>
                                        <p className='text-white '>
                                        
Export the visitors’ data to a .csv file<br/>
