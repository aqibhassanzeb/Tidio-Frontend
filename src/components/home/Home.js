        ...
        <div className='container-home'>
            ...
            <div className='row-home'>
                ...
                <div className='colleft-home'>
                    <h3>
                        Feel the value Tidio brings to your business
                    </h3>
                    ...
                    activeTab == 2 && <>
                        <div className='colright-second'>
                            <div className='right-second1'>
                                <h3>Currently you have no visitor.
                                    But you can simulate one!</h3>
                                <p>Talk with yourself and see how your visitor’s experience will look like.</p>
                                <button type='button' className='simulate-btnss'>Simulate conversation</button>
                            </div>
                            <img className='img0-chat' src={chatimages} />
                        </div>
                    </>
                }

                {
                    ...
                    <>
                        ...
                        <div className='right-third1'>
                            <h3>Build a relationship with your customers even when you are not around</h3>
                            <button type='button' className='chatbots-btnss'> Go to chatbots</button>
                            <img className='chatbots-img' src= {chatsvg} />
                        </div>
                        </div>
                    </>
                }
